...
extension UIViewController {
    ...
    /// Defines a standard identifier for a Segue from viewController identifier + to viewController identifier
    ...
    /// Defines a standard identifier for a Cell tableViewCell identifier + viewController identifier
